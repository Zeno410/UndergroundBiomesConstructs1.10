...
public class ImmersiveEngineeringRegistrar extends ModOreRegistrar {
  ...
  public void register(RegistryEvent.Register<Block> event) {
    registerOre(event, oreName, 1, ModInfo.MODID + ":blocks/overlays/copper");
    registerOre(event, oreName, 3, ModInfo.MODID + ":blocks/overlays/aluminum");
    ...
    registerOre(event, oreName, 3, ModInfo.MODID + ":blocks/overlays/nickel");
    registerOre(event, oreName, 3, ModInfo.MODID + ":blocks/overlays/uranium");
  }
}
