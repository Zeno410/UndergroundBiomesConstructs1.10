...
public final class RegularStoneRecipe implements SettingTracker<Integer> {
	...
	public void update(Integer value) {
		...
		StonesRegistry.INSTANCE.stonesFor(UBStoneStyle.COBBLE).forEach(cobbleEntry -> {
			...
			case 3:
				recipes.add(new ShapedRecipes(2, 2, new ItemStack[] { cobble, cobble, cobble, cobble }, new ItemStack(Blocks.COBBLESTONE)));
			case 4:
				recipes.add(new ShapedRecipes(2, 2, new ItemStack[] { cobble, cobble, cobble, cobble }, new ItemStack(Blocks.COBBLESTONE, 4)));
			}
		});
		// Add the new recipes
